...
class Nivel(models.Model):
    nivel = models.CharField('Nível', max_length=20, null=False, blank=False)

    def __str__(self):
        return self.nivel

    class Meta:
        verbose_name_plural = u'Níveis do Programa'
...
class Programa(models.Model):
    ...
    # nivel = models.CharField('Nível do programa', choices=choices.NIVEL_PROGRAMA_CHOICE, max_length=2, default='M')
    pagina_web = models.CharField('Endereço para a página do mestrado', null=True, blank=True, max_length=800)
    niveis = models.ManyToManyField(Nivel)

    def __str__(self):
        return self.nome_diploma
...
class OrganizacaoPrograma(models.Model):
    ...
    item = models.CharField('Tipo', choices=choices.CONCORRENCIA, max_length=20, default=choices.CONCORRENCIA[1][0])
    ...
    def __str__(self):
        return f'{self.programa.sigla} {self.nome}'
